...
public class EurekaService {
    ...
    public boolean autenticar(String usuario, String clave) {
        try {
            System.out.println("Conectando al Microservicio SOAP de Autenticación para Web...");
            ...
            System.err.println("ERROR Web: El Microservicio de Autenticación NO está disponible o falló: " + e.getMessage());
            return false;
        }
    }
