...
public class LoginServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        // Validación remota con el Microservicio de Autenticación
        if (usuario != null && password != null) {
            ...
            if (authOk) {
                System.out.println("Login exitoso en Microservicio - Creando sesión");
                ...
                System.out.println("Error de Autenticación en Microservicio");
            }
        } else {
        ...
        request.setAttribute("error", "Error de Autenticación: Credenciales incorrectas o Microservicio fuera de línea (Undeployed)");
        request.getRequestDispatcher("/login.jsp").forward(request, response);
    }
