...
public class Movimiento {
    ...
    // MÃ©todo para obtener la fecha como una cadena de texto en el formato deseado
    ...
    public void setFechaFromString(String fechaString) {
        try {
            ...
            // Manejar la excepciÃ³n en caso de que ocurra un error al convertir la fecha
            e.printStackTrace();
        }
    }
}
