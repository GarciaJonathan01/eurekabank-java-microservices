...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnLogin.setOnClickListener {
            ...
            Toast.makeText(this, "Validando credenciales en Microservicio REST...", Toast.LENGTH_SHORT).show()

            restService.autenticar(usuario, password, object : EurekaRestService.RestCallback<Boolean> {
