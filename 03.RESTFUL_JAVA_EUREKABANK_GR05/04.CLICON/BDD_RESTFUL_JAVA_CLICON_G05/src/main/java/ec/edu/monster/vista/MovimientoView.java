 ...
 * DiseÃ±o mejorado similar al cliente .NET
 */
...
public class MovimientoView {
    ...
    /**
     * Obtiene la descripciÃ³n del tipo de movimiento basado en el cÃ³digo
     */
    ...
    public static void mostrarMovimientos(List<Movimiento> movimientos, int anchoCuadro) {
        ...
        int width = 120; // Ancho estÃ¡ndar de consola
        int startPos = (width - anchoCuadro) / 2;
        if (startPos < 0) startPos = 0;
        
        // AsignaciÃ³n de anchos para columnas
        int anchoCuenta = 15;
        int anchoNroMov = 8;
        int anchoFecha = 12;
        int anchoTipo = 20;
        ...
        String encabezado = String.format(
            ...
            "Cuenta", "Nro Mov.", "Fecha", "Tipo", "AcciÃ³n", "Importe"
        );
